...
public class AverageGradeTest {
  private MapDriver<LongWritable, Text, CourseAndStudentWritable, IntWritable>                                                mapDriver;
  private ReduceDriver<CourseAndStudentWritable, IntWritable, CourseAndStudentWritable, FloatWritable>                        reducerDriver;
  private MapReduceDriver<LongWritable, Text, CourseAndStudentWritable, IntWritable, CourseAndStudentWritable, FloatWritable> mapRedDriver;
  ...
  public void testMapper() throws IOException {
    ...
    mapDriver.withOutput(new CourseAndStudentWritable("Algorithms", "Fabio"), new IntWritable(66));
    mapDriver.withOutput(new CourseAndStudentWritable("Database", "Marco"), new IntWritable(86));
    mapDriver.withOutput(new CourseAndStudentWritable("Algorithms", "Fabio"), new IntWritable(63));
  ...
  public void testReducer() throws IOException {
    ...
    values.add(new IntWritable(55));
    values.add(new IntWritable(51));
