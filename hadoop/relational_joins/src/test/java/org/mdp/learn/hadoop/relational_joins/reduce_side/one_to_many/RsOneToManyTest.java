...
public class RsOneToManyTest {
  ...
  public void testReduce() throws IOException {
    reducerDriver.withInput(new JoinKey("1", 1), Arrays.asList(new Text("1;Marco;Italy;CDCMDP")))
    ...
    reducerDriver.withInput(new JoinKey("3", 1), Arrays.asList(new Text("3;Gordon;Scotland;GRDXWV")))
